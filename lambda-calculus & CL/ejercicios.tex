...
El término teórico $[x].M$, qe no es un CL-término en sí mismo, actuará de forma equivalente a $\lambda x.M$ y se creará como una combinación de los términos \textbf{I, K} y \textbf{S} de la siguiente forma: 
\begin{enumerate}
  \renewcommand{\labelenumi}{\alph{enumi})}
